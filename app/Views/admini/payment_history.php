                        ...
                        <tbody>
                          <?php
                                ...
                                foreach ($transactions as $key => $transaction) {
                                    ...
                                    if(($member['status'] == 0 || $member['approve_status'] != 2) && $transaction['payment_type'] == "service_fee") continue;
                                    ...
                                    if($transaction['payment_type'] == "checkout"){
                                        ...
                                        $checkout_type = $checkout_type == "" ? $checkout_type = "CC":$checkout_type;
                                        echo '<td>Paid By '.$checkout_type.'</td>';
                                        ...
                                        if($checkout_type == "eCheck")
                                          echo '<td> Bank Account:'.$card_number.'</td>';
                                        else
                                          echo '<td> Card Number:'.$card_number.'</td>';
