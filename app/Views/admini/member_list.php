                      ...
                      <table id="example" class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings" style="background-color:#24652e">
                            ...
                            <th class="column-title">Sub Domain</th>
                        ...
                        <tbody>
                         ...
                         ?>
                          ...
                          <tr >
                            ...
                            <td>
                              <?php 
                                if($member['status'] == 0) echo "<span style='color:black;'>Suspend</span>"; else {
                                  if($member['approve_status'] == 0) echo "<span style='color:blue;'>Pending</span>";
                                  if($member['approve_status'] == 1) echo "<span style='color:green;'>Under Reiew</span>";
                                  if($member['approve_status'] == 2) echo "<span style='color:red;'>Active</span>";
                                  if($member['approve_status'] == 3) echo "<span style='color:red;'>Inactive</span>";
                                }
                              ?>
                            </td>

                            <td>
                              <?php if($member['subdomain'] == "") echo "virsympay"; else  echo $member['subdomain']; ?>
                            </td>
                            ...
                            <td style="text-align: right;" class="td-action">
                             <?php
                                if($member['status'] == 0 ) {
                               ?>
                              <a data-status="0" data-id="<?php echo $member["id"]?>" class="btn btn-round btn-default action-btn" data-type="unsuspend">
                                <i class="fa fa-check red"></i> Unsuspend
                              </a>
                              <?php } ?>
                              <?php
                                if($member['status'] != 0) {
                              ?>
                               <a data-status="0" data-id="<?php echo $member["id"]?>" class="btn btn-round btn-default action-btn"  data-type="suspend">
                                  <i class="fa fa-remove green"></i> Suspned
                                </a>
                              <?php
                                }
                              ?>
                              ...
                              ?>
                               <a data-status="0" data-id="<?php echo $member["id"]?>" class="btn btn-round btn-default action-btn"  data-type="inactive">
                                  <i class="fa fa-remove red"></i> Inactive
                                </a>
                              <?php
                                }
                              ?>
                              ...
                              <?php
                                if($member['status'] != 0 && ($member['approve_status'] == 3 || $member['approve_status'] == 1)) {
                              ?>
                               <a data-status="0" data-id="<?php echo $member["id"]?>" class="btn btn-round btn-default action-btn"  data-type="active">
                                  <i class="fa fa-check red"></i> Active
                                </a>
                              <?php
                                }
                              ?>
                               ...
                               <a href="<?php echo base_url('admini/customer/businesInfo/'.$member["id"]); ?>" data-id=" <?php echo $member["id"]?> " class="btn btn-round btn-default">
                               ...
                               <a href="<?php if($member['subdomain'] == 'ecopay') 
                                  echo "https://ecopay.virsympay.com"."/admini/user/fast_login/".$member["id"]; 
                                  else if($member['subdomain'] == 'deepay') 
                                  echo "https://deepay.virsympay.com"."/admini/user/fast_login/".$member["id"]; 
                                  else echo base_url("admini/user/fast_login/".$member["id"]); ?> " class="btn btn-round btn-default" target="_blank">
  ...
  $(document).ready(function(){
    ...
    $("body").on("click",".bank-info",function(){
     ...
     $("body").on("click",".action-btn",function(){
        ...
        type = $(this).data("type");
        $.ajax({
          url: BASE_URL + "admini/customer/action_member",
    ...
    $("body").on("click",".active-btn",function(){
        ...
        status = $(this).data("status");
        $.ajax({
          url: BASE_URL + "admini/customer/active_member",
