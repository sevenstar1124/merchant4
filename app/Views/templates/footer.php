...
<footer id="footer">
    <div class="container">
        <div class="col-md-12" style="text-align: center;">
            <p class="copyright">&copy Virsympay All Rights Reserved Copyright: <span>
                    <script>
                        document.write(new Date().getFullYear())
                    </script><!-- </span> Design and Developed by <a href="http://www.Themefisher.com" target="_blank">Themefisher</a>. <br> 
                            Get More 
